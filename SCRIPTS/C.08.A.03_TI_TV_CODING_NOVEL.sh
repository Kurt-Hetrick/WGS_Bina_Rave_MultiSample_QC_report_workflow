...
-et NO_ET \
-K $KEY \
--variant $CORE_PATH/$PROJECT/SNV/MULTI/CODING/PASS_VARIANT/$SM_TAG".CODING.SNV.PASS.VARIANT.vcf" \
--discordance /isilon/sequencing/GATK_resource_bundle/2.8/b37/dbsnp_138.b37.excluding_sites_after_129.vcf \
-o $CORE_PATH/$PROJECT/TEMP/$SM_TAG".Coding.Release.Novel.TiTv.vcf"

vcfutils-0.1.18.pl qstats $CORE_PATH/$PROJECT/TEMP/$SM_TAG".Coding.Release.Novel.TiTv.vcf" >| \
$CORE_PATH/$PROJECT/REPORTS/TI_TV_MS/CODING/$SM_TAG"_Novel_titv.txt"
