...
-et NO_ET \
-K $KEY \
--variant $CORE_PATH/$PROJECT/SNV/MULTI/WHOLE_GENOME/PASS_VARIANT/$SM_TAG".WHOLE.GENOME.SNV.PASS.VARIANT.vcf" \
--concordance /isilon/sequencing/GATK_resource_bundle/2.8/b37/dbsnp_138.b37.excluding_sites_after_129.vcf \
-o $CORE_PATH/$PROJECT/TEMP/$SM_TAG".WG.Release.Known.TiTv.vcf"

vcfutils-0.1.18.pl qstats $CORE_PATH/$PROJECT/TEMP/$SM_TAG".WG.Release.Known.TiTv.vcf" \
>| $CORE_PATH/$PROJECT/REPORTS/TI_TV_MS/WHOLE_GENOME/$SM_TAG"_Known_titv.txt"
