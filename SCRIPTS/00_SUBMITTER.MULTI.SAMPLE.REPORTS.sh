...
bgzip-0.2.6 -c /isilon/sequencing/Seq_Proj/$PROJECT/$MDNA_HASH_ADDRESS/VQSR/$PROJECT".REFINED.vcf" \
>| /isilon/sequencing/Seq_Proj/$PROJECT/$MDNA_HASH_ADDRESS/VQSR/$PROJECT".REFINED.vcf.gz"
