...
-o $CORE_PATH/$PROJECT/TEMP/$SM_TAG".Coding.Release.Known.TiTv.vcf"

vcfutils-0.1.18.pl qstats $CORE_PATH/$PROJECT/TEMP/$SM_TAG".Coding.Release.Known.TiTv.vcf" \
>| $CORE_PATH/$PROJECT/REPORTS/TI_TV_MS/CODING/$SM_TAG"_Known_titv.txt"
