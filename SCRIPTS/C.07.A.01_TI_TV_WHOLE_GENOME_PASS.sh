...
vcfutils-0.1.18.pl qstats $CORE_PATH/$PROJECT/SNV/MULTI/WHOLE_GENOME/PASS_VARIANT/$SM_TAG".WHOLE.GENOME.SNV.PASS.VARIANT.vcf" \
>| $CORE_PATH/$PROJECT//REPORTS/TI_TV_MS/WHOLE_GENOME/$SM_TAG"_All_titv.txt"
