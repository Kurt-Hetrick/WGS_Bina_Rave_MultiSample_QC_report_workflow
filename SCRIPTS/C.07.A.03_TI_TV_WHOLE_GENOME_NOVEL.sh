...
-o $CORE_PATH/$PROJECT/TEMP/$SM_TAG".WG.Release.Novel.TiTv.vcf"

vcfutils-0.1.18.pl qstats $CORE_PATH/$PROJECT/TEMP/$SM_TAG".WG.Release.Novel.TiTv.vcf" >| \
$CORE_PATH/$PROJECT/REPORTS/TI_TV_MS/WHOLE_GENOME/$SM_TAG"_Novel_titv.txt"
