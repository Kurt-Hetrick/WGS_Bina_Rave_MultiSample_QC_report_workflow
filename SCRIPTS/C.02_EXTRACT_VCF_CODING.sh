...
-o $CORE_PATH/$PROJECT/VCF/MULTI/CODING/$SM_TAG".CODING.vcf"

bgzip-0.2.6 -c $CORE_PATH/$PROJECT/VCF/MULTI/CODING/$SM_TAG".CODING.vcf" \
>| $CORE_PATH/$PROJECT/VCF/MULTI/CODING/$SM_TAG".CODING.vcf.gz"

tabix-0.2.6 -f -p vcf $CORE_PATH/$PROJECT/VCF/MULTI/CODING/$SM_TAG".CODING.vcf.gz"
