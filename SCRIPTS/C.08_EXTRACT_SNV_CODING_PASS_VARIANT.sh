...
-o $CORE_PATH/$PROJECT/SNV/MULTI/CODING/PASS_VARIANT/$SM_TAG".CODING.SNV.PASS.VARIANT.vcf"

qsub -N "C.08.A.01_TI_TV_CODING_PASS_"$RIS_ID"_"$BARCODE_2D \
-o $CORE_PATH/$PROJECT/LOGS/$SM_TAG".TITV.CODING.PASS.MS.log" \
-e $CORE_PATH/$PROJECT/LOGS/$SM_TAG".TITV.CODING.PASS.MS.log" \
$CORE_PATH/$PROJECT/SCRIPTS/C.08.A.01_TI_TV_CODING_PASS.sh $1 $2 $3 $4 $5

sleep 3s

qsub -N "C.08.A.02_TI_TV_CODING_KNOWN_"$RIS_ID"_"$BARCODE_2D \
-o $CORE_PATH/$PROJECT/LOGS/$SM_TAG".TITV.CODING.KNOWN.MS.log" \
-e $CORE_PATH/$PROJECT/LOGS/$SM_TAG".TITV.CODING.KNOWN.MS.log" \
$CORE_PATH/$PROJECT/SCRIPTS/C.08.A.02_TI_TV_CODING_KNOWN.sh $1 $2 $3 $4 $5

sleep 3s

qsub -N "C.08.A.03_TI_TV_CODING_NOVEL_"$RIS_ID"_"$BARCODE_2D \
-o $CORE_PATH/$PROJECT/LOGS/$SM_TAG".TITV.CODING.NOVEL.MS.log" \
-e $CORE_PATH/$PROJECT/LOGS/$SM_TAG".TITV.CODING.NOVEL.MS.log" \
$CORE_PATH/$PROJECT/SCRIPTS/C.08.A.03_TI_TV_CODING_NOVEL.sh $1 $2 $3 $4 $5
