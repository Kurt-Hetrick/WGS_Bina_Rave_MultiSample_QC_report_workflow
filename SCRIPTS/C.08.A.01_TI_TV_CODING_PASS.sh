...
vcfutils-0.1.18.pl qstats $CORE_PATH/$PROJECT/SNV/MULTI/CODING/PASS_VARIANT/$SM_TAG".CODING.SNV.PASS.VARIANT.vcf" \
>| $CORE_PATH/$PROJECT//REPORTS/TI_TV_MS/CODING/$SM_TAG"_All_titv.txt"
