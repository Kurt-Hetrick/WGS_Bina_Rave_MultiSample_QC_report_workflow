...
-o $CORE_PATH/$PROJECT/VCF/MULTI/WHOLE_GENOME/$SM_TAG".WHOLE.GENOME.vcf"

bgzip-0.2.6 -c $CORE_PATH/$PROJECT/VCF/MULTI/WHOLE_GENOME/$SM_TAG".WHOLE.GENOME.vcf" \
>| $CORE_PATH/$PROJECT/VCF/MULTI/WHOLE_GENOME/$SM_TAG".WHOLE.GENOME.vcf.gz"

tabix-0.2.6 -f -p vcf $CORE_PATH/$PROJECT/VCF/MULTI/WHOLE_GENOME/$SM_TAG".WHOLE.GENOME.vcf.gz"
